...
**This whole portion for Python versions is really just aesthetics. If you're okay with typing 'python3' every time, then that's fine! Go to the [next lesson](Using_Interpreter.md)**
